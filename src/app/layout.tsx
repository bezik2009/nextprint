...
// Microsoft Clarity — only injected when CLARITY_ID is set
...
export const metadata: Metadata = {
  ...
  title: "NextPrint — Контрактне виробництво пластикових компонентів",
  description:
    ...
    images: [
      {
        ...
        height: 630,
        type: "image/png",
        alt: "NextPrint — Контрактне виробництво пластикових компонентів",
      },
    ],
  },
