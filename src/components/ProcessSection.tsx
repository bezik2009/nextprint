...
const STEPS = [
  ...
  },
  {
    n: "02",
    Icon: IconSearch,
    title: "Інженерний аналіз",
    desc: "Оцінюємо конструкцію, підбираємо матеріал, розраховуємо вартість та строки.",
  },
  {
    n: "03",
    Icon: IconPrinter,
    title: "Виробництво",
    desc: "Виготовляємо деталі на виробничій лінії. Контролюємо повторюваність партії.",
  },
  {
    n: "04",
    Icon: IconShield,
    title: "Контроль якості",
    desc: "Перевіряємо розміри, геометрію, поверхню та зовнішній вигляд деталей.",
  },
  {
    n: "05",
    Icon: IconPackage,
    title: "Контроль та відвантаження",
    ...
    <section id="process" className="np-proc" aria-label="Процес роботи">
      ...
      <div className="np-proc-header">
        ...
        <p className="np-proc-sub">
          Прозорий виробничий процес від вашої задачі<br />до готових компонентів на складі.
        </p>
      </div>
